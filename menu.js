        ...
        generateObject: function(settings)
            {
                ...
                var obj = new Bun(rows[0][settings.shape].getGeom(),rows[3][settings.color].fgColor);
                rows[1][settings.mutation].setMutation(obj);
                rows[2][settings.pulse].setPulse(obj);
        ...
        transformTo: function(obj,settings,fog,renderer)
            {
                ...
                var other = new Bun(rows[0][obj.shape].getGeom(),rows[3][obj.color].fgColor);
                other.obj.geometry = oldGeom;

                rows[0][settings.shape].setShape(obj);
                ...
                var col = new THREE.Color(rows[3][settings.color].fgColor).getHSL();
                ...
                if(renderer)
                {
                    var col = new THREE.Color(rows[3][settings.color].bgColor).getHSL();
                ...
                if(fog)
                {
                    var col = new THREE.Color(rows[3][settings.color].mgColor).getHSL();
